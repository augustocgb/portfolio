        ...
        <Card>
          <div className="grid gap-8 md:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="animate-fade-up">
                Created a Python Flask web application that allows users to build and manage a personalized stock watchlist. 
                The app leverages the yfinance library to fetch real-time stock prices and key financial data, providing up-to-date information for each ticker in the user's list. 
                Users can add or remove stocks, view live updates, and customize their watchlist according to their interests.
                All user data and preferences are stored in a local JSON file, ensuring persistence across sessions without the need for a database. 
